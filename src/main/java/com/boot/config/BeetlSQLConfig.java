...
//        conf.setBasePackage("com.boot.dao");
//        conf.setDaoSuffix("FruitDao");//为了不影响之前的代码，默认一般后缀写Dao
...
//        return DataSourceBuilder.create().url("jdbc:mysql://127.0.0.1:3306/test").username("root").password("tiger").build();
//    }
//
//    //开启事务
//    @Bean(name = "txManager")
